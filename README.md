...
## Перечень команд для пользователя
  ...
  * **/search** ***имя_игры***  - вывод результатов по поиску игры
  ...
  ![/search_app](https://user-images.githubusercontent.com/32519543/33964854-017c7212-e06b-11e7-82c4-32b917ab809a.PNG)
## Перечень команд, используемых пользователем не напрямую
  * **/app_** ***app_id*** - Вывод полной информации об игре с использованием текстового шаблона. 
  ...
  ![/app_id](https://user-images.githubusercontent.com/32519543/33964881-0f833404-e06b-11e7-9931-64b3308853df.PNG)
  * **/scr_** ***app_id*** - Вывод всех доступных скриншотов по игре. Может быть введена явно
  или кликом в сообщении бота.
  
  ![/scr](https://user-images.githubusercontent.com/32519543/33964903-25b8d882-e06b-11e7-9eaf-44a51db29aa9.PNG)
  * **/news_** ***app_id*** - Вывод 10 последних новостей по игре. Использование аналогично предыдущим
  непрямым командам.
  
  ![/news](https://user-images.githubusercontent.com/32519543/33964926-38993a96-e06b-11e7-8820-ed3ac112bcd5.PNG)
